  ...
  >
    <div class="by-music-body">
      ...
      <div class="by-music-pic">
        <el-image :src="list[current].cover" fit="cover"
        style="    height: 66px;
    width: 66px;"
        >
        ...
        >
          <span  icon="el-icon-loading" v-if="loading" />
          <span :icon="status ? 'el-icon-video-pause' : 'el-icon-video-play'" v-else  />
        </span>
      </div>
        ...
        <div class="by-music-controller">
          ...
          <div class="by-music-time">
            ...
            <span
              ...
              :icon="status ? 'el-icon-video-pause' : 'el-icon-video-play'"
              @click="$emit('click-toggle')"
            />
            <!-- 下一首 -->
            <span
            ...
            <div class="by-volume-wrap">
              <span class="by-music-icon" :icon="volumeStyle" />
              <BySlider
            ...
            <span
              ...
              :type="cycleMode == 0 ? 'el-icon-s-unfold' : 'el-icon-refresh-right'"
      ...
      <div
        ...
        v-if="mode == 'fixed'"
      >
        <span :type="bodyShow ? 'iconright' : 'iconright-copy'" />
      </div>
      <!-- 歌曲列表 -->
    </div>
    <!-- 歌词 -->
