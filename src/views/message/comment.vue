<template>
  <div class="comment">
      <div class="header">
          <el-image  :src="avater" class="user">
          ...
          <textarea placeholder="Just write down" class="editor" v-model="content"></textarea>
      </div>
      <div class="body">
          <div class="preview">
              
              <span title="表情" class="emoji-btn iconfont icon-biaoqing" @click="clickShow(false)">
                  
              </span>
              <span title="预览" class="emoji-btn iconfont icon-preview" @click="clickShow(true)"></span>
          </div>
          <div>
