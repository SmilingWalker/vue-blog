      ...
      <div class="blog container">
          <div class="left">
              ...
              <div class="label concise">
                  <router-link v-for="item of labelList" :key="item" :to="'/blog?label=' + item" 
                    class="label-item" :class="{'label-item-active':$route.query.label == item}">{{item}}</router-link>
              </div>
          </div>
          <div class="right"
            ...
            <div class="article concise" v-for="item of list" :key="item.id">
              ...
              <div class="body">
                  ...
                  <span class="content" v-html="item.desc"></span>
              </div>
              <div class="footer">
